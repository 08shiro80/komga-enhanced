# [1.24.4-fork-0.1.5.0](https://github.com/08shiro80/komga-enhanced/compare/v1.24.4-fork-0.1.4.2...v1.24.4-fork-0.1.5.0) (2026-05-14)
## ✨ Features
**komga**
- add manga scrobbling to AniList, MyAnimeList, Kitsu, and MangaDex
- add comic scrobbling to Metron
- add auto-match (Komf-style) for automatic tracker link discovery on series import
- add tracker links support for series metadata with two-way sync
